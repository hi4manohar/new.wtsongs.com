...
$id3 = new getID3();
  ...
  function listFolderFiles($dir){
    ...
    foreach($ffs as $ff){
      if($ff != '.' && $ff != '..'){
        ...
        if($ext == "mp3") {
          $last4char = substr($ff, -5);
          if($last4char == " .mp3" OR $last4char == ". mp3" OR $last4char == ". mp3" OR $last4char == ".  mp3" OR $last4char == ".   mp3") {
          //if($ff == ".mp3") {
            echo '<li>' . $ff;
          }      
          //echo '<li>' . $ff;
  ...
  listFolderFiles('O:\cdn.wtsongs.com\song_category\telugu');
?>